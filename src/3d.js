	...
	Diapo.prototype.loading = function () {
		...
		if ((this.canvas && this.srcImg.complete) || this.img.complete) {
			...
			if (this.canvas) {
				...
				if(this.srcImg.width > 1000) {
					this.w = this.srcImg.width / 4;
					this.h = this.srcImg.height / 4;
				} else if (this.srcImg.width > 500){
					this.w = this.srcImg.width / 2;
					this.h = this.srcImg.height / 2;
				} else {
